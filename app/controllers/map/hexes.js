...
export default Ember.ObjectController.extend(DrawMixin, HexPick, HexPart, {
    ...
    colors: [ "Town", "Trail", "River", "Swamp", "Forest", "Roughone", "Roughtwo", "Mountain", "Road", "Secondaryroad", "Sunkenroad", "Elevation", "Redoubt", "Wadi", "Slope", "ReinforceZoneA", "ReinforceZoneB", "ReinforceZoneC", "ReinforceZoneD", "ReinforceZoneE", "Blocked", "BlocksNonRoad", "SpecialHexA", "SpecialHexB", "SpecialHexC", "SpecialHexD", "SpecialHexE", "Mine", "Minedroad", "FortA", "FortB"],
    selectedColor: "Town"
  }
);